...
export function getSystemPrompt(): string {
  ...
  const jsonMaker = `Randomly ncorporate formatted json snippets from the json text \`${mejson}\` in  your responses. When you do, ensure that the JSON is valid and properly escaped. The JSON should be wrapped in markdown code blocks.`

  const prompts = [rewriter]
